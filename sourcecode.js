...
const jsScoreIndex = skills.findIndex((x) => x === "JS");
const reactScoreIndex = skills.findIndex((x) => x === "React");
const jsScore = scores[jsScoreIndex];
const reactScore = scores[reactScoreIndex];
